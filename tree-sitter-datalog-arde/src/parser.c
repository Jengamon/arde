...
enum {
  ...
  sym_source_file = 18,
  sym__constraint = 19,
  sym_rule_definition = 20,
  sym_fact_definition = 21,
  sym_goal_definition = 22,
  sym_body_atom = 23,
  sym_atom = 24,
  sym_predicate = 25,
  sym_identifier = 26,
...
static inline bool aux_sym_predicate_token2_character_set_6(int32_t c) {
  return (c < 19968
    ? (c < 3520
      ? (c < 2616
        ? (c < 1646
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 55:
      ...
      if (aux_sym_predicate_token2_character_set_5(lookahead)) ADVANCE(55);
      END_STATE();
    case 56:
      ACCEPT_TOKEN(aux_sym_predicate_token2);
      if (lookahead == 'a') ADVANCE(59);
      if (aux_sym_predicate_token2_character_set_6(lookahead)) ADVANCE(65);
      END_STATE();
    case 57:
      ACCEPT_TOKEN(aux_sym_predicate_token2);
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym__constraint] = STATE(4),
    [sym_rule_definition] = STATE(4),
    [sym_fact_definition] = STATE(4),
    [sym_goal_definition] = STATE(4),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [36] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_predicate, 1),
  [38] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_atom, 1),
  [40] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [42] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule_definition, 4, .production_id = 1),
  [44] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_rule_definition, 4, .production_id = 1),
  ...
  [56] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_atom, 5),
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule_definition, 5, .production_id = 1),
  [60] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_rule_definition, 5, .production_id = 1),
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_atom, 3),
  [64] = {.entry = {.count = 1, .reusable = true}}, SHIFT(7),
  [66] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [68] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_body_atom, 1),
  [70] = {.entry = {.count = 1, .reusable = true}}, SHIFT(5),
  [72] = {.entry = {.count = 1, .reusable = true}}, SHIFT(11),
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_body_atom, 2),
  ...
  [84] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_rule_definition_repeat1, 2), SHIFT_REPEAT(6),
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_rule_definition_repeat1, 2),
  [89] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_atom_repeat1, 2), SHIFT_REPEAT(5),
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_atom_repeat1, 2),
  [94] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_term, 1),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_boolean, 1),
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_atomic_string, 1),
